...
Room0 = Room.new(0,'white','w','e','Oh look its a bear. Take a selfie? [yes] or [no]','the bear just bit you ','nice move','no','yes')
Room1 = Room.new(1, 'yellow','s','n','Its a lion. Pet it?','shouldve pet the lion. they like that. he slashed your jugular', 'lions love to be pet','yes','no')
Room2 = Room.new(2, 'red','e','w','theres a green potion, drink it?','should drank that','potion is good','yes','no')
